...
![image-20230306203640445](D:\学习资料\EC-MO-main\assets\image-20230306203640445.png)
...
![image-20230306203810533](D:\学习资料\EC-MO-main\assets\image-20230306203810533.png)

## 信息素进行更新：

经过𝑛个时刻，蚂蚁可走完所有的城市，完成一次循环。每只蚂蚁所走过的路径就是一个解。此时，要根据下面的更新规则对各条路径上的信息素进行更新：

![image-20230306203841809](D:\学习资料\EC-MO-main\assets\image-20230306203841809.png)
...
![image-20230306203858672](D:\学习资料\EC-MO-main\assets\image-20230306203858672.png)

∆𝜏_𝑖𝑗^𝑘表示蚂蚁k在本次循环中在城市𝑖和𝑗之间留下的信息素：

![image-20230306203917380](D:\学习资料\EC-MO-main\assets\image-20230306203917380.png)
...
![image-20230306204006787](D:\学习资料\EC-MO-main\assets\image-20230306204006787.png)
...
![image-20230306204140556](D:\学习资料\EC-MO-main\assets\image-20230306204140556.png)
...
- - 以蚂蚁1为例，当前城市i=A，可访问城市集合J_1(i)={B,C,D}。计算蚂蚁1选择B，C，D作为下一访问城市的概率：
  - ![image-20230306204158513](D:\学习资料\EC-MO-main\assets\image-20230306204158513.png)
  ...
  - ![image-20230306204238239](D:\学习资料\EC-MO-main\assets\image-20230306204238239.png)
...
- - - 计算每只蚂蚁构建的路径长度：C_1=3+4+2+1=10，C_2=4+2+1+3=10，C_3=2+1+5+4=12。更新每条边上的信息素：
    - ![image-20230306204505471](D:\学习资料\EC-MO-main\assets\image-20230306204505471.png)
